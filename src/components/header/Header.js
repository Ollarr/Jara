  ...
  <div className="container sticky px-6 py-3 mx-auto md:flex">
    <div className="flex items-center justify-between">
      <div>
        ...
        style={{ fontFamily: "Courgette", border: "2px solid #4ade80", padding:"8px"
        }} >JARA</h1>
      </div>
...
{/* Mobile Menu open: "block", Menu closed: "hidden" */}
    ...
    <div className="collapse w-full md:flex md:items-center md:justify-between" id="navbarSupportedContent">
      ...
      <div className="relative">
        ...
        <input type="text" className="w-auto py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Search"></input>
        </div>
        <ul>
