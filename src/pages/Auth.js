...
const Auth = ({setActive}) => {
  ...
  return (
    ...
    <a href="Google.com" class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
          <div class="px-4 py-2">
...
{signUp && (
  <>
   <div class="mt-4">
      <label className="text-left block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="LoggingEmailAddress">First Name</label>
    ...
    <div class="mt-4">
      <label className="text-left block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="LoggingEmailAddress">Last Name</label>
    ...
    <div class="mt-4">
      <label className="text-left block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="LoggingEmailAddress">Email Address</label>
    ...
    <div className="mt-4">
      <div className="flex justify-between">
        <label className="text-left block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="loggingPassword">Password</label>
...
{signUp && (
  <div class="mt-4">
      <label className="text-left block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="LoggingEmailAddress">Confirm Password</label>
